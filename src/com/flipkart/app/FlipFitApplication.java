...
public class FlipFitApplication {
    ...
    private static GymFlipFitCustomerMenu customerMenu;
    private static GymFlipFitAdminMenu adminMenu;
    private static GymFlipFitGymOwnerMenu gymOwnerMenu;

    static {
        User admin = new Admin(); // Assuming Admin extends User
        users.put(admin.getUsername(), admin);
    }

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        GymCustomerInterface gymCustomerService = new GymCustomerService(null); // Initialize with null for now

        customerMenu = new GymFlipFitCustomerMenu(gymCustomerService);
        adminMenu = new GymFlipFitAdminMenu(); // Initialize admin menu
        gymOwnerMenu = new GymFlipFitGymOwnerMenu(); // Initialize gym owner menu
